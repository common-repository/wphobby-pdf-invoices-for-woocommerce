<?php
/*
Plugin Name: WooCommerce PDF Invoices Maker
Plugin URI: http://wphobby.com
Description: Generate WooCommerce PDF Invoice and attach with order email for WooCommerce automatically.
Version: 1.2.9
Author: wphobby
   ...
   function whpdf_install_premium_admin_notice() {
      ...
      if (!get_user_meta($user_id, 'whpdf_admin_notice_ignore')) {
         ...
         echo sprintf(
             ...
             sprintf(
                 __("Like WPHobby WooCommerce PDF Invoice Maker free version? You can also buy our premium version <a href='https://1.envato.market/62LDr'>Here</a> <div class='alert_close'><a href='?whpdf-ignore-notice'>Dismiss</a></div>", "wphobby-woo-pdf-invoice")
             )
         );
